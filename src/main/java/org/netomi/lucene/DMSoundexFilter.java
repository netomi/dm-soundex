...
import org.netomi.codec.DMSoundex;

/**
 * Create tokens for phonetic matches based on Daitch–Mokotoff Soundex.
 */
public final class DMSoundexFilter extends TokenFilter {
    /** true if encoded tokens should be added as synonyms */
    protected boolean inject = true;
    /** phonetic encoder */
    protected DMSoundex encoder = new DMSoundex();
     ...
     */
    public DMSoundexFilter(TokenStream in, boolean inject) {
        super(in);
        this.inject = inject;
    }
