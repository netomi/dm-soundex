...
/**
 * Tests {@link DMSoundexFilter}
 */
public class DMSoundexFilterTest extends BaseTokenStreamTestCase {
...
//        assertAlgorithm(false, "aaa bbb ccc easgasg", new String[] { "000000", "700000", "400000", "045450" });
    ...
    static void assertAlgorithm(boolean inject, String input, String[] expected) throws Exception {
        ...
        DMSoundexFilter filter = new DMSoundexFilter(tokenizer, inject);
    ...
    public void testRandomStrings() throws IOException {
        Analyzer a = new Analyzer() {
            ...
            protected TokenStreamComponents createComponents(String fieldName, Reader reader) {
                ...
                return new TokenStreamComponents(tokenizer, new DMSoundexFilter(tokenizer, false));
            }
        };
